...
- fix: wrong metadata for PostAside ([@julrich](https://github.com/julrich))
...
- feature: add author bio to blog post ([@julrich](https://github.com/julrich))
